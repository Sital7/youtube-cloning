...
const Sidebar = ({ sidebar, category, setCategory }) => {
  ...
  useEffect(() => {
    if (category === 'liked') {
      ...
      // fetch(`https://www.googleapis.com/youtube/v3/playlistItems?key=${API_KEY}&part=snippet&playlistId=LL${USER_CHANNEL_ID}`)
  ...
  useEffect(() => {
    if (category === 'story') {
      ...
      // fetch(`https://www.googleapis.com/youtube/v3/search?key=${API_KEY}&part=snippet&q=story&type=video`)
